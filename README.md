...
Clone the Repository: Download these .ipynb files to your local machine or directly upload them to your Google Drive.

Prepare your Dataset: Organize your retinal images (e.g., .png, .jpg) into specific folders on your Google Drive.

Open in Google Colab: Open the notebooks using Google Colab.

Mount Google Drive: Run the provided cell at the top of the notebooks to connect Colab to your Drive:

Python
from google.colab import drive
drive.mount('/content/drive')
Adjust Folder Paths: Modify the input_folder and output_folder variable paths in the code to match the exact location of your dataset in your Google Drive.

Run All Cells: Execute the cells sequentially to see the generated histograms and segmentation results.

📊 Expected Output
Histograms: Saved .png files showing bar charts of pixel intensities for specific color channels.

Overlayed Plots: Line graphs comparing the distribution of two different regions.

Segmented Images: The original retinal image plotted with a blue elliptical boundary accurately enclosing the detected Optic Cup.
